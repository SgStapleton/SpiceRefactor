...
class NaifSpice():
    ...
    def _naif_keywords(self):
        ...
        naif_keywords['INS{}_BORESIGHT_SAMPLE'.format(self.ikid)] = self._detector_center_sample
        naif_keywords['INS{}_BORESIGHT_LINE'.format(self.ikid)] = self._detector_center_line
